    ...
    b.extend(b.rsProto, {
        _d6: function() {
            ...
            a.st.globalCaption && (a.ev.on("rsAfterInit", function() {
                ...
                var rs = $('#full-width-slider1 .rsSlide');
                    var rsnav = $('#full-width-slider1 .rsBullets .rsNavItem');
                    
                    for (var n = 0; n < rs.length; n++) {

                        var sd = $(rs[n].children[1].children[0].children[0]).attr('alt');
                        var sdnav = $(rsnav[n].children[0]).html(sd);
                          console.log(sd[1]);
